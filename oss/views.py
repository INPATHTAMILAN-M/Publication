...
def reviewer_invitations(request): 
    ...
    reviewer_spl = Reviewer_Specialization.objects.filter(reviewer=author)
    ...
    if request.method == 'POST' and 'specializations' in request.POST:
        ...
        for spec_id in selected_ids:
            ...
            Reviewer_Specialization.objects.create(reviewer=author, specialization=specialization)
    ...
    if request.method == 'POST':
        ...
        if submission_id:
            ...
            send_email(
                ...
                subject='Review Message Updated',
                template_name='email_templates/reviewer_review.html',
                user=editor,
                context={
                    'submission': submission, 
                    'reviewer': user, 
                    'editor': editor,
                    'review_recommendation': submission_reviewer.review_recommendation,
